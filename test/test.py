...
class TestCSVReader(unittest.TestCase):
    ...
    def testRead(self):
        ...
        records = list(occurrence.getLines("id", "Cruise68:Station565:EventSorbeSledge9781:Subsample17409"))
        ...
        records = list(occurrence.getLines("eventID", "Cruise68:Station622:EventSorbeSledge10018:Subsample15224"))
    ...
    def testFieldNamesDict(self):
        ...
        records = list(occurrence.getLines("scientificName", "Neomysis integer"))
    ...
    def testFieldNamesList(self):
        ...
        records = list(occurrence.getLines("eventID", "Cruise68:Station593:EventSorbeSledge9887:Subsample16687"))
