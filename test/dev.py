...
#event = CSVReader("data/event2.txt", delimiter="\t", quoteChar=None, indexFields=["eventID", "parentEventID", "id"], fieldNames=names)
#print json.dumps(event.indexes(), indent=4)

event = CSVReader("data/occurrence_blanklines.txt", delimiter="\t", quoteChar=None, indexFields=["institutionCode"], skipBlank=True)
print json.dumps(event.indexes(), indent=4)
